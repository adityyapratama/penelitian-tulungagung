            ...
            <form action={formAction}>
              <CardHeader className=" pb-6">
                ...
                <CardDescription className="text-base">
                  Lengkapi informasi di bawah ini untuk membuat puzzle baru
                  dalam sistem
                </CardDescription>
              </CardHeader>
                ...
                <div className="grid gap-6">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <div className="text-xs text-muted-foreground">
                                Puzzle tentang destinasi wisata
                              </div>
                            </div>
                          </div>
                        </SelectItem>
                        <SelectItem value="Tokoh_Sejarah">
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <div className="text-xs text-muted-foreground">
                                Puzzle tentang tokoh bersejarah
                              </div>
                            </div>
                          </div>
                        </SelectItem>
                        <SelectItem value="Peta">
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <div className="text-xs text-muted-foreground">
                                Puzzle tentang geografi dan peta
                              </div>
                            </div>
                          </div>
                        </SelectItem>
                        <SelectItem value="Budaya">
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <div className="text-xs text-muted-foreground">
                                Puzzle tentang budaya dan tradisi
                              </div>
                            </div>
                          </div>
                        </SelectItem>
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-xs text-muted-foreground">
                      XP yang akan diberikan kepada pengguna setelah
                      menyelesaikan puzzle (1-1000)
                    </p>
                  </div>
                </div>
              </CardContent>
