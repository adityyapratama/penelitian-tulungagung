...
import { StorySceneNode } from "../../components/story-scene-node"
import { EndingSceneNode } from "../../components/ending-scene-node"
...
export default function Page() {
  ...
  const updateScene = useCallback(
    (updatedScene: StoryScene) => {
      const updatedScenes = scenes.map((scene) => (scene.scene_key === updatedScene.scene_key ? updatedScene : scene))
      setScenes(updatedScenes)
      setNodes(createNodesFromScenes(updatedScenes))
      setEdges(createEdgesFromScenes(updatedScenes))
