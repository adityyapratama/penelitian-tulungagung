...
export function ArticleDataTable<TData extends Record<string, any>, TValue>({
  columns,
  data,
  categories = [],
          ...
          <div className="flex flex-col space-y-2 md:flex-row md:items-center md:justify-between md:space-y-0 p-4 bg-muted/50 rounded-lg border-border border">
            <div className="flex items-center space-x-2">
              <Badge variant="secondary" className="font-medium">
                {selectedRowsCount} artikel dipilih
              </Badge>
            </div>
      ...
      <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
        <div className="flex flex-col space-y-2 md:flex-row md:items-center md:space-y-0 md:space-x-4">
          <div className="text-sm text-muted-foreground text-center md:text-left">
            ...
            dari {table.getFilteredRowModel().rows.length} artikel
          </div>
          {selectedRowsCount === 0 && (
            <Button
              variant="outline"
