...
const SIDEBAR_WIDTH = "18rem"; // Diperbesar dari 16rem (menjadi 288px)
const SIDEBAR_WIDTH_MOBILE = "20rem"; // Diperbesar dari 18rem
      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ...
            : "group-data-[collapsible=icon]:w-(--sidebar-width-icon) group-data-[side=left]:border-r group-data-[side=right]:border-l border-sidebar-border", // <-- TAMBAHKAN DI SINI
          className
        )}
        {...props}
      >
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      className={cn(
        "mx-3.5 flex min-w-0 translate-x-px flex-col gap-1  py-1",
        "group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
